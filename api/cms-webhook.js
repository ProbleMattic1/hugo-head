// Headless CMS Webhook Handler for Vercel
// This function handles webhooks from your headless CMS to trigger site rebuilds
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (webhookSecret && req.headers['x-cms-signature']) {
    ...
    console.log('CMS webhook received:', {
      event: payload.event,
      model: payload.model,
      id: payload.id,
